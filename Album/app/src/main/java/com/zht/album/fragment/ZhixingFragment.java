...
public class ZhixingFragment extends Fragment {
...
//防止无故销毁
        ...
        viewCourse = inflater.inflate(R.layout.zhixing,container, false);

        meizistest= ParseJson.ParseJsonWithGson("2");
        ...
        recyclerview.addOnScrollListener(new RecyclerView.OnScrollListener() {
            ...
            public void onScrollStateChanged(RecyclerView recyclerView, int newState) {
                ...
                if (newState == RecyclerView.SCROLL_STATE_IDLE
                    ...
                    List<String> more= ParseJson.ParseJsonWithGson("2");
